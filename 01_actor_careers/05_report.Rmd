...
This got me thinking about the rest of the dataset. Given our **12,258** films dataset isn't limited to director credits in our top 250 (films in the set are contributed by both actor and director credits) we can get a bit of a better idea of the broader gender split of directors. I've captured a lot of the key numbers in the following chart.
