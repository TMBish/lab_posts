...
We should sense check the gender mapping. Let's take a random 10 people to check is working as desired:
...
Things get dicey with a name like Sandy; however, the package obviously knows that most Sandys born in 1937 were female so we'll have to trust it here. Otherwise the list looks pretty, pretty, pretty good.
...
To answer this question we'll first need to calculate a person's age at the time of their appearance in a film. We'll then 
