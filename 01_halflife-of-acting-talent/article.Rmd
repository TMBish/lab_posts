...
create_finding = function(finding_text) {
  ...
  .finding img {
    ...
    <div class='finding'>
      ...
      <div class='sidebar'><img src='https://github.com/TMBish/lab_posts/blob/master/00_utilities/lightbulb.png?raw=true'><span> Finding!</span></div>
      
      <div class='body'> <span> <<finding_text>> </span> </div>
...
films %>% 
  ...
  pandoc.table(emphasize.strong.cols = 3, missing="?")
...
genders %>%
  ...
  pandoc.table(emphasize.strong.cols = 3)
```
...
gender_prop_finding = create_finding("The average age of a female actor at the time of film production is 28!")
...
master %>% 
  ...
  pandoc.table(emphasize.strong.cols = 7)
