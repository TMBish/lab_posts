...
- **Shiny Apps** are the most interactive format with few limitations but require a computer server to host as well as codifying a decent amount of interactivity logic in the shiny syntax. This can be too much overhead for smaller tasks.
...
Using `highcharter` we'll plot the densities of these 3 distributions.
